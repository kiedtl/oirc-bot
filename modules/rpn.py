...
async def init(self):
  self.help['rpn'] = ['rpn <inp> - simple reverse polish notation calculator (more)', 'it has an alias of . so you can just do {}. <inp> and also there are 4 f8jct90js (+|a) (-|s) (*|x|m) (/|d)']
  self.cmd['rpn'] = rpninp
  self.cmd['.'] = rpninp
